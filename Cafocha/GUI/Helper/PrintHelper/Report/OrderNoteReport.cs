...
namespace Cafocha.GUI.Helper.PrintHelper.Report
{
    ...
    public class OrderNoteReport : IListPdfReport
    {
        ...
        public IPdfReportData CreateDetailsPdfReport(RepositoryLocator unitofwork, DateTime startTime, DateTime endTime,
            string folderName)
        {
            return new PdfReport().DocumentPreferences(doc =>
                {
                ...
                .MainTableTemplate(template => { template.BasicTemplate(BasicTemplate.BlackAndBlue2Template); })
                .MainTablePreferences(table =>
                {
                    table.ColumnsWidthsType(TableColumnWidthType.Relative);
        ...
        public IPdfReportData CreateEntityPdfReport(RepositoryLocator unitofwork, DateTime startTime, DateTime endTime,
            string folderName)
        {
            return new PdfReport().DocumentPreferences(doc =>
                {
